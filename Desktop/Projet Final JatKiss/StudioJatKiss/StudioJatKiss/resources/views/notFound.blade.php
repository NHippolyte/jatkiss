...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="alert alert-danger text-center">
                    <h1 class="display-4">Utilisateur Inconnu</h1>
                    <p class="lead">Désolé, l'utilisateur que vous recherchez est inconnu.</p>
    ...
    <!-- Ajouter le lien vers le script JavaScript de Bootstrap (jQuery et Popper.js sont requis pour Bootstrap) -->
